        ...
        <div class="row text-center">
                <div class="col-lg-5 col-md-6 d-flex  mx-auto" data-aos="zoom-in" data-aos-delay="100">
                  ...
                  <a href = "https://www.youtube.com/channel/UCr_jeNBhNP9oSqI92sWH8VQ"  target="_blank">
                    <img class =" bt mt-4 mx-2"src='/assets/img/sc.png' style = {{width:"25%",height: "20%"}}></img>
                  </a>
                  <a href = "https://soundcloud.com/xanuchiha2002"  target="_blank">
                   
                    <img class =" bt mt-4 mx-2"src='/assets/img/yt.png' style = {{width:"25%",height: "20%"}}></img>
                  </a>
                ...
                <div class="col-lg-5 col-md-6 d-flex  mx-auto" data-aos="zoom-in" data-aos-delay="100">
                  ...
                  <a class = "bt" style = {{color:'black', fontWeight:'bold'}} href = "https://lichess.org/@/andrew223344"  target="_blank">
